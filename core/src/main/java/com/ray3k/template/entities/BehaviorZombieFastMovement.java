...
public class BehaviorZombieFastMovement extends BehaviourAdapter<Box2DGameObject>{
    private Box2DGameObject gameObject;
    private static final Vector2 temp = new Vector2();
    public float speed;
    private float maxSpeed;
    
    public BehaviorZombieFastMovement(Box2DGameObject gameObject, float speed) {
        super(gameObject);
